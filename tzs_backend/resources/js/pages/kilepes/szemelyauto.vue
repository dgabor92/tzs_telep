<template>
    <div class="vld-parent">
        ...
        <card :title="$t('Szemelyauto_info')">
            <v-list-item v-for="item in filteredSzemelyauto" :key="item.id" link>
...
export default {
    ...
    mounted() {
        this.getSzemelyautos()
    },
    computed: {
        filteredSzemelyauto() {
            return this.szemelyautos.filter((item) => item.kilepes_datuma === null)
        },
    },
    methods: {
        closeDialog() {
        ...
        async updateItem(item) {
            ...
            const { data } = await axios.put(`/api/szemelyautok`, this.selectedItem)
